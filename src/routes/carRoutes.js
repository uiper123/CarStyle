...
router.post('/cars', authMiddleware, isAdminOrEmployee, upload.array('images', 10), async (req, res) => {
  try {
...
router.put('/cars/:id', authMiddleware, isAdminOrEmployee, upload.array('images', 10), async (req, res) => {
  try {
...
router.delete('/cars/:carId/images/:imageId', authMiddleware, isAdminOrEmployee, async (req, res) => {
  try {
...
router.put('/cars/:carId/images/:imageId/primary', authMiddleware, isAdminOrEmployee, async (req, res) => {
  try {
    const { carId, imageId } = req.params;
...
router.put('/:id', authMiddleware, isAdminOrEmployee, upload.array('images', 10), async (req, res) => {
  // ... код функции ...
});

// Удаление автомобиля
router.delete('/:id', authMiddleware, isAdminOrEmployee, async (req, res) => {
  // ... код функции ...
});

// Удаление изображения автомобиля
router.delete('/:carId/images/:imageId', authMiddleware, isAdminOrEmployee, async (req, res) => {
  // ... код функции ...
});

// Обновление статуса автомобиля
router.put('/:id/status', authMiddleware, isAdminOrEmployee, async (req, res) => {
  // ... код функции ...
});
