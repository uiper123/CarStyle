...
import { FaUser, FaEdit, FaCar, FaHistory, FaCamera, FaKey, FaIdCard, FaPassport } from 'react-icons/fa';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userData = {
        ...
        patronymic: profileData.middlename || '',
        phone: profileData.phone || '',
        driverLicense: profileData.driver_license || '',
      ...
      const response = await axios.put('http://localhost:3002/api/user/profile/update', userData, {
        headers: { 
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
